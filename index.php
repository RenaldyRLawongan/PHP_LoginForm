...
if (isset($_POST['submit'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<script>alert('Your email, username, or password is incorrect. Please try again!')</script>";
    }
}
...
<body>
    ...
    <div class="container">
        <form action="" method="POST" class="login-email">
            ...
            <p class="login-register-text">Create a new account click here! <a href="register.php">Register</a></p>
        </form>
    </div>
</body>
